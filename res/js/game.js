...
function crap() {
    ...
    if (againRoll === 0) {
        ...
        if (checkWinResult === true) {
            ...
            document.getElementById("notice").innerHTML = "The sum of the two dice is " + point + " </br>Roll again until you reach " + point + "."; // update the notice
...
function playAgain(){
	...
	document.getElementById("notice" ).innerHTML = "Please roll the dice to start playing"; // change the notice text
